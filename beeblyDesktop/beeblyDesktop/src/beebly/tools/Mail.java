...
public class Mail {
    ...
    private static String username = "beeblyinfo@gmail.com";
    private static String password = "seglwyquwwpazols";
...
// Etape 2 : Création de l'objet Message
            ...
            message.setFrom(new InternetAddress("beeblyinfo@gmail.com"));
