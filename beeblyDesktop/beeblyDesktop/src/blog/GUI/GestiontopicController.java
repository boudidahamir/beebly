...
//   public  static int iduser=Utilisateur.user_connecter.getId();
     ...
     *
     */
    public  static int iduser=UserService.currentuser.getId();
    @FXML
 ...
 { 
    ...
    try {
        ...
        Logger.getLogger(GestiontopicController.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            loader.setLocation(getClass().getResource("/blog/GUI/updatetopic.fxml"));
                            try {
                                loader.load();
...
//                           
                        ...
                        stage.close();
                         Parent root = FXMLLoader.load(getClass().getResource("/blog/GUI/gestionsujet.fxml"));
    ...
    private void ajoutertopic(MouseEvent event)  {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/blog/GUI/ajoutertopic.fxml"));
    ...
    private void weather(MouseEvent event) {
         ...
         try {
            Parent parent = FXMLLoader.load(getClass().getResource("/blog/GUI/Primary.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
            stage.initStyle(StageStyle.UTILITY);
