...
//                           
                        ...
                        stage.close();
                        Parent root = FXMLLoader.load(getClass().getResource("/blog/GUI/gestioncommentaireback.fxml"));
...
tvsujet.setItems(sujetlist);
    ...
    try {
                Parent page1 = FXMLLoader.load(getClass().getResource("/blog/GUI/gestiontopicback.fxml"));
