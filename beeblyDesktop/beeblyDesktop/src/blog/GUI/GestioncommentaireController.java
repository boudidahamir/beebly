...
import static blog.GUI.GestionsujetController.idtopic;
import de.jensd.fx.glyphs.fontawesome.FontAwesomeIcon;
import de.jensd.fx.glyphs.fontawesome.FontAwesomeIconView;
import beebly.entity.Commentaire;
...
if(GestiontopicController.iduser==sujet.getIduser()){
        ...
        if (result.get() == ButtonType.OK) {
            ...
            alert2.close();
                ...
                tvcommentaire.setItems(scom.getcommentbysujet(idsujet)); 
                            ...
                            loader.setLocation(getClass().getResource("/blog/GUI/updatecommentaire.fxml"));
                            try {
                                loader.load();
    ...
    private void backtopic(MouseEvent event) {
        ...
        try {
                Parent page1 = FXMLLoader.load(getClass().getResource("/blog/GUI/gestionsujet.fxml"));
    ...
    private void ajoutercommentaire(MouseEvent event) {
         try {
            ...
            Parent parent = FXMLLoader.load(getClass().getResource("/blog/GUI/ajoutercommentaire.fxml"));
