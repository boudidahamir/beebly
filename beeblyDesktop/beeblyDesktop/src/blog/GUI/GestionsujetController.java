...
import beebly.entity.Sujet;
import beebly.entity.Topic;
...
import beebly.services.ServiceCommentaireIMP;
import beebly.services.ServiceSujetIMP;
import beebly.services.ServiceTopicIMP;
...
GestiontopicController  gestiontopicController=new GestiontopicController();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        labelusername.setText(user.getNom());
        ...
        if (result.get() == ButtonType.OK) {
            ...
            alert2.close();
                ...
                tvsujet.setItems(ssujet.getsujetbytopicaccepter(idtopic)); 
                            ...
                            loader.setLocation(getClass().getResource("/blog/GUI/updatesujet.fxml"));
                            try {
                                loader.load();
...
//                           
                        ...
                        stage.close();
                        Parent root = FXMLLoader.load(getClass().getResource("/blog/GUI/comments.fxml"));
...
tvsujet.setItems(sujetlist);
    ...
    private void backtopic(MouseEvent event) {
            ...
            try {
                Parent page1 = FXMLLoader.load(getClass().getResource("/blog/GUI/gestiontopic.fxml"));
    ...
    private void ajoutersujet(MouseEvent event) {
        ...
        try {
            ...
            Parent parent = FXMLLoader.load(getClass().getResource("/blog/GUI/ajoutersujet.fxml"));
