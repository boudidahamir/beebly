...
public class ListPropositionForm extends BaseForm {

        public ListPropositionForm( Resources res) throws IOException {
                ...
                swipe.getContentPane().setUIID("Container");
                swipe.hideTabs();
                setTitle("List propositions");
                setLayout(BoxLayout.yCenter());
                ArrayList<PropositionLivre> list;
                list = new ArrayList<>();
                list = ServiceProposition.getInstance().getAll();
                ...
                for ( PropositionLivre c : list) {
                        ...
                        upd.addActionListener((evt) -> {
                                ...
                                new EditPropositionForm(res,c).show();

                        });
                        addAll(sp2,spl,spl2,spl3,spl4,sup,upd)
                        ;}
