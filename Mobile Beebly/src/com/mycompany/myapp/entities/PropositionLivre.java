...
public class PropositionLivre {
  ...
  public PropositionLivre(int idProposition, User user, String titreLivre, String editon, String descriptionEtat) {
  ...
  public PropositionLivre(User user, String titreLivre, String editon, String descriptionEtat) {
    this.user = user;
    this.titreLivre = titreLivre;
    this.editon = editon;
    this.descriptionEtat = descriptionEtat;
  ...
  public PropositionLivre(int idProposition, User user, String titreLivre, String editon, String descriptionEtat, Date dateProposition) {
    this.idProposition = idProposition;
    this.user = user;
    this.titreLivre = titreLivre;
    this.editon = editon;
